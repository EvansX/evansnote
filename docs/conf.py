...
htmlhelp_basename = 'EvansNote_doc'
...
latex_documents = [
  (master_doc, 'EvansNote.tex', u'EvansNote Documentation',
   u'EvansNote', 'manual'),
]
...
man_pages = [
    (master_doc, 'EvansNote', u'EvansNote Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'EvansNote', u'EvansNote Documentation',
   author, 'EvansNote', 'documents of EvansNote',
   'Miscellaneous'),
]
